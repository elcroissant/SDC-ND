...
As a last step, I normalized the image data because the range of values of raw data can vary widely. In best case scenario we should make sure that each feature contributes approximately proportionately to the metric classifier uses.
...
To train the model, I used an AdamOptimizer, 30 Epochs, batch size: 64 images, learning rate: 0.001 
